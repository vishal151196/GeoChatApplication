    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                saveToPreferences(userName);        //saves userName entered above in sharedPreferences

                Intent intent = new Intent(getApplicationContext(), ChatActivity.class);    //opens new activity
