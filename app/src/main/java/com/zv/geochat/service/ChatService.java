...
public class ChatService extends Service {
    ...
    public static final int CONNECT_ERROR_62 = 62;
    public static final int CMD_RANDOM = 1;

    public static final String KEY_MESSAGE_TEXT = "message_text";
    public static final String KEY_USER_NAME = "user_name";
    public static final String SEND_RANDOM_ID = "random_id";
    ...
    private void handleData(Bundle data) {
        ...
        //**Connect Error**//
            ...
            // comparing command with connect error
        } else if (command == CONNECT_ERROR_62) {
            String testMessage = "Connect Error: 62";
            String studentID = "62";
            notificationDecorator.displaySimpleNotification("Connect Error: "+ studentID, testMessage);

            // comparing command with random_number
        } else if (command == CMD_RANDOM) {
            String randomID = (String) data.get(SEND_RANDOM_ID);
            notificationDecorator.displaySimpleNotification("Chat Service Received: ", randomID);
            //**Connect Error**//
        }  else {
